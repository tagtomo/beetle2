class BankAccountsController < ApplicationController
  ...
  private
    ...
    def bank_account_params
      params.require(:bank_account).permit(:number, :data_type, :bank_cd, :store_cd, :account_type, :account_number, :account_holder, :account_holder_k, :transfer_method, :transfer_request_date, :stop_flg, :start_date, :end_date)
    end
end
